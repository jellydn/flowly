...
├── tests/             # Node test-runner tests (52 files + helpers)
...
- Contains: 52 `.test.ts` files + `helpers.ts` (fixture builders, tool invocation)
